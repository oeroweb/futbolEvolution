...
<body>
	...
	<div class="grid-container">
		...
		<div class="container-main">
			<div class="center">
				<h2 class="title">Editando Banner - Página Ligas</h2>
				...
				<div class="container-wrap w100">
					...
					?>
							<form action="models/updates/upleaguebanner.php" class="box-formulario" enctype="multipart/form-data" method="post">
								<div class="w100 container-wrap mg-bt10">
									...
									<div class="box-input">
										...
										<textarea class="w100" name="en_descripcion" placeholder="intro description" rows="6"><?= $dato['en_descripcion'] ?></textarea>
										<textarea class="w100" name="es_descripcion" placeholder="ingresa una descripción" rows="6"><?= $dato['es_descripcion'] ?></textarea>
									</div>
									<div class="box-input">
