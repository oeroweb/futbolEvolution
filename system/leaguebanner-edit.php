					...
					<form action="models/updates/upleaguebanner.php" class="box-formulario" enctype="multipart/form-data" method="post">
						<div class="w100 container-wrap mg-bt10" >
							...
							<div class="box-input">
								...
								<textarea class="w100" name="en_descripcion" rows="6" ><?=$dato['en_descripcion']?></textarea>		
								<textarea class="w100" name="es_descripcion" rows="6" ><?=$dato['es_descripcion']?></textarea>							
							</div>											
						</div>						
