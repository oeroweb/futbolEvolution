<?php
  ...
  if($resultado){
    for($i = 0; $i < count($arreglo_columna_a); $i++){
      $consulta = $ME -> Registrar_Excel($arreglo_columna_a[$i], $arreglo_columna_b[$i], $arreglo_columna_c[$i], $arreglo_columna_d[$i], $arreglo_columna_e[$i], $arreglo_columna_f[$i], 2, $fecha);
    }
