  ...
  if($resultado){
    ...
    if (
      ...
      for ($i = 0; $i < $total; $i++) {        
        ...
        $sql2 = "INSERT INTO `ligasbarrapartidos`(`equipo_id_a`, `en_titulo`, `en_descripcion`, `resultados`, `en_subtitulo`, `equipo_id_b`, `liga_id`,`estado_id`, `fecha`) 
            VALUES ('$a', '$b', '$c', '$d', '$e', '$f', $idliga, 2, CURDATE());";
