...
// $sql = "SELECT u.*, e.nombre as nombreestado, p.nombre as pais FROM usuarios u INNER JOIN paises p on u.nacionalidad = p.id INNER JOIN estados e on u.estado_id = e.id WHERE u.estado_id = 2;";
