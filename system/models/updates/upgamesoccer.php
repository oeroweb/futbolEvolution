<?php 
    ...
    $beneficio5 = isset($_POST['beneficio5']) ? $_POST['beneficio5'] : 1;
		...
		$sql="UPDATE detallepartido SET fecha_partido='$fechapartido', hora='$hora', genero='$genero', total_jugadores=$total_jugadores, total_equipos=$total_equipos, en_nivel='$nivel', costo=$costo, beneficio1=$beneficio1, beneficio2=$beneficio2, beneficio3=$beneficio3, beneficio4=$beneficio4, beneficio5=$beneficio5, local_id=$idlocal, estado_id=2 WHERE id = '$id';";
