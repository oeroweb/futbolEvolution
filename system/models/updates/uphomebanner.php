    ...
    $es_descripcion = isset($_POST['es_descripcion']) ? $_POST['es_descripcion'] : false;
		...
		if($nombre_imagen){
			if($tipo_imagen=="image/jpeg" || $tipo_imagen=="image/jpg" || $tipo_imagen=="image/png" || $tipo_imagen4=="image/svg"){
				...
				$carpeta_destino = $_SERVER['DOCUMENT_ROOT'] . '/assets/img/home/';	
				...
				header("Location: ../../homebanner-edit.php?id=$id");
				die();
			}		
		}else{
		...
		$sql="UPDATE homebanner SET en_titulo='$en_titulo', es_titulo='$es_titulo', en_descripcion='$en_descripcion', es_descripcion='$es_descripcion', imagen='$subir_imagen' WHERE id = $id;";
