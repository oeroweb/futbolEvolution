<?php 
    ...
    $es_descripcion = isset($_POST['es_descripcion']) ? $_POST['es_descripcion'] : false;
		...
		$sql="UPDATE homeslider SET en_titulo='$en_titulo', es_titulo='$es_titulo', en_descripcion='$en_descripcion', es_descripcion='$es_descripcion', imagen='$subir_imagen'  WHERE id = $id;";
