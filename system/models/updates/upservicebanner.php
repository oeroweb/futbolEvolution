<?php 
    ...
    if ($nombre_archivo) {
      ...
      $subir_archivo = $documento;
		...
		$sql="UPDATE serviciosbanner SET en_titulo='$en_titulo', es_titulo='$es_titulo', en_descripcion='$en_descripcion', es_descripcion='$es_descripcion', archivo='$subir_archivo' WHERE id = $id;";
